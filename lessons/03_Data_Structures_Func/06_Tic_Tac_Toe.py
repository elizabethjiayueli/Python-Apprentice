...
def check_win(board):
    for col in (board):
        if check_row(col)==str(X_MARK):
            return X_MARK
        elif check_row(col)==str(O_MARK):
            return O_MARK
    for col in (zip(*board)):
        if check_row(col)==str(X_MARK):
            ...
            return O_MARK
    if board[0][0]==board[1][1] and board[1][1]==board[2][2] and board[2][2]==X_MARK:
        return X_MARK
    elif board[0][0]==board[1][1] and board[1][1]==board[2][2] and board[2][2]==O_MARK:
        return O_MARK
    elif board[0][2]==board[1][1] and board[1][1]==board[2][1] and board[2][1]==O_MARK:
        return O_MARK
    elif board[0][2]==board[1][1] and board[1][1]==board[2][1] and board[2][1]==X_MARK:
        return X_MARK
